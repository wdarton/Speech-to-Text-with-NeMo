...
pip install "nemo_toolkit[asr]" pyaudio numpy


Usage

Save the provided Python script as realtime_asr.py in your working directory.

Ensure your microphone is connected and configured as the default input device on your Debian system.
